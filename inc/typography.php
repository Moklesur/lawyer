...
function themetim_typography_color($color) {
    ...
    $btn_default_bg_hover = get_theme_mod( 'btn_default_bg_hover', '#fff' );
    $btn_default_text_hover = get_theme_mod( 'btn_default_text_hover', '#e27763' );
    $btn_default_border_hover = get_theme_mod( 'btn_default_border_hover', '#e27763' );
    ...
    $btn_primary_text_hover = get_theme_mod( 'btn_primary_text_hover', '#e27763' );
    $btn_primary_border_hover = get_theme_mod( 'btn_primary_border_hover', '#e27763' );
    ...
    $btn_success_bg_hover = get_theme_mod( 'btn_success_bg_hover', '#fff' );
    $btn_success_text_hover = get_theme_mod( 'btn_success_text_hover', '#e27763' );
    $btn_success_border_hover = get_theme_mod( 'btn_success_border_hover', '#e27763' );
